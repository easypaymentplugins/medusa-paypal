...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  const resolveAdminOrigin = (): string => {
    ...
    console.warn(
      "[PayPal] onboard-return: PAYPAL_ADMIN_ORIGIN/ADMIN_CORS not set \u2014 relaying onboarding result to postMessage origin '*'. Set PAYPAL_ADMIN_ORIGIN to your admin URL to restrict it."
    )
    return "*"
  }
