...
exports.recordMetricAtomic = recordMetricAtomic;
/**
 ...
 */
async function recordMetricAtomic(db, name, metadata) {
    try {
        ...
        await db.raw(`INSERT INTO paypal_metric (id, name, data, created_at, updated_at)
       VALUES (
         ?, ?,
