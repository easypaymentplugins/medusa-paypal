...
const paypal_webhook_process_1 = require("../../../../subscribers/paypal-webhook-process");
const webhook_verify_1 = require("../../../../modules/paypal/utils/webhook-verify");
...
async function verifyWebhookSignature(paypal, environment, body, headers, rawBody) {
    ...
    const requestBody = (0, webhook_verify_1.composeVerifyRequestBody)(verifyFields, (0, webhook_verify_1.resolveWebhookEventJson)(rawBody, body));
    const resp = await (0, paypal_fetch_1.paypalFetch)(`${base}/v1/notifications/verify-webhook-signature`, {
        method: "POST",
        headers: {
...
async function POST(req, res) {
    ...
    try {
        ...
        const rawBody = (0, webhook_verify_1.rawBodyToString)(req.rawBody);
    ...
    try {
        ...
        await eventBus.emit({
            name: paypal_webhook_process_1.PAYPAL_WEBHOOK_RECEIVED_EVENT,
            data: { id: recordId },
        });
